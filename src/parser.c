...
enum ts_symbol_identifiers {
  ...
  sym_arrow_type = 32,
  sym_assert_stmt = 33,
  sym_formula_type_binder = 34,
  sym_formula_arrow_type = 35,
  sym_formula = 36,
  ...
  aux_sym_term_stmt_repeat1 = 42,
  aux_sym_type_repeat1 = 43,
  aux_sym_assert_stmt_repeat1 = 44,
  aux_sym_math_string_repeat1 = 45,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1);
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(69);
      END_STATE();
    case 2:
    ...
    case 69:
      ...
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(69);
      END_STATE();
    case 70:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(95),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term_stmt, 6, 0, 2),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 4, 0, 3),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 1, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 3, 0, 2),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term_stmt, 5, 0, 2),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 5, 0, 4),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assert_stmt, 6, 0, 2),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 6, 0, 5),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assert_stmt, 5, 0, 2),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 7, 0, 6),
  [73] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_math_string_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [76] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_math_string_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_math_string_repeat1, 2, 0, 0),
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_math_string_repeat1, 2, 0, 0), SHIFT_REPEAT(28),
  ...
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_type_repeat1, 2, 0, 0),
  [104] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_type_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_math_token, 3, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_math_token, 1, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_math_string_repeat1, 1, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_math_token, 2, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 1, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_type_repeat1, 1, 0, 0),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assert_stmt_repeat1, 2, 0, 0),
  [121] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assert_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(54),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assert_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(55),
  [127] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [129] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [131] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_term_stmt_repeat1, 2, 0, 0),
  [135] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_term_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(49),
  [138] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_term_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(50),
  ...
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formula, 1, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_list, 1, 0, 0),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_math_string, 2, 0, 0),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_term_stmt_repeat1, 1, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_math_string, 3, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assert_stmt_repeat1, 1, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_binder, 5, 0, 7),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formula_type_binder, 5, 0, 7),
  [181] = {.entry = {.count = 1, .reusable = true}}, SHIFT(93),
  [183] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arrow_type, 1, 0, 0),
  [187] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formula_arrow_type, 1, 0, 0),
  ...
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arrow_type, 3, 0, 0),
  ...
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formula_arrow_type, 3, 0, 0),
  ...
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 1),
};
