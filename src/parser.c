...
enum ts_symbol_identifiers {
  ...
  sym_type_binder = 34,
  sym_arrow_type = 35,
  sym_type_variables = 36,
  sym_assert_stmt = 37,
  sym_formula_type_binder = 38,
  sym_formula_arrow_type = 39,
  sym_formula = 40,
  sym_def_stmt = 41,
  sym_dummy_binder = 42,
  sym_dummy_argument_list = 43,
  sym_argument_list = 44,
  sym_math_string = 45,
  sym_math_token = 46,
  sym_math_bang_token = 47,
  sym_comment = 48,
  aux_sym_source_file_repeat1 = 49,
  aux_sym_term_stmt_repeat1 = 50,
  aux_sym_type_variables_repeat1 = 51,
  aux_sym_assert_stmt_repeat1 = 52,
  aux_sym_def_stmt_repeat1 = 53,
  aux_sym_dummy_argument_list_repeat1 = 54,
  aux_sym_math_string_repeat1 = 55,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_math_bang_token] = "math_bang_token",
  [sym_comment] = "comment",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_math_bang_token] = sym_math_bang_token,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(76);
      if (lookahead != 0 &&
    ...
    case 3:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(3);
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(78);
      END_STATE();
    case 4:
    ...
    case 76:
      ACCEPT_TOKEN(aux_sym_math_token_token1);
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(78);
      END_STATE();
    case 77:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_sort_stmt] = STATE(18),
    [sym_term_stmt] = STATE(18),
    [sym_assert_stmt] = STATE(18),
    [sym_def_stmt] = STATE(18),
    [sym_comment] = STATE(1),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(122)] = 2020,
  [SMALL_STATE(123)] = 2030,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(114),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(128),
  [44] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(98),
  [47] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(115),
  [50] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(129),
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 7, 0, 7),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_def_stmt, 8, 0, 2),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 4, 0, 3),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 1, 0, 0),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 5, 0, 5),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term_stmt, 5, 0, 2),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assert_stmt, 5, 0, 2),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_def_stmt, 5, 0, 2),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 6, 0, 6),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term_stmt, 6, 0, 2),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assert_stmt, 6, 0, 2),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_def_stmt, 6, 0, 2),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sort_stmt, 3, 0, 2),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_def_stmt, 7, 0, 2),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1, 0, 0),
  [86] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_math_string_repeat1, 2, 0, 0), SHIFT_REPEAT(20),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_math_string_repeat1, 2, 0, 0),
  [91] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_math_string_repeat1, 2, 0, 0), SHIFT_REPEAT(39),
  [94] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_math_string_repeat1, 2, 0, 0), SHIFT_REPEAT(41),
  [97] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_math_string_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  ...
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 1, 0, 4),
  ...
  [128] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_type_variables_repeat1, 2, 0, 0), SHIFT_REPEAT(28),
  [131] = {.entry = {.count = 1, .reusable = false}}, SHIFT(40),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_type_variables_repeat1, 1, 0, 0),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_variables, 1, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [139] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_math_string_repeat1, 1, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_math_token, 1, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_math_token, 2, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_math_bang_token, 3, 0, 0),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_math_token, 3, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_math_bang_token, 4, 0, 0),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assert_stmt_repeat1, 2, 0, 0),
  [155] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assert_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(75),
  [158] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assert_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(76),
  ...
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_term_stmt_repeat1, 2, 0, 0),
  [175] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_term_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(69),
  [178] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_term_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(70),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_def_stmt_repeat1, 2, 0, 0),
  [183] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_def_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(57),
  [186] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_def_stmt_repeat1, 2, 0, 0), SHIFT_REPEAT(53),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 2, 0, 4),
  ...
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dummy_argument_list_repeat1, 2, 0, 0),
  [209] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dummy_argument_list_repeat1, 2, 0, 0), SHIFT_REPEAT(116),
  [212] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dummy_argument_list_repeat1, 2, 0, 0), SHIFT_REPEAT(62),
  ...
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dummy_argument_list, 1, 0, 0),
  ...
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formula, 1, 0, 0),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument_list, 1, 0, 0),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_math_string, 2, 0, 0),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dummy_argument_list_repeat1, 1, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_def_stmt_repeat1, 1, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_math_string, 3, 0, 0),
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_term_stmt_repeat1, 1, 0, 0),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_binder, 5, 0, 8),
  [247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formula_type_binder, 5, 0, 8),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assert_stmt_repeat1, 1, 0, 0),
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dummy_binder, 5, 0, 8),
  [253] = {.entry = {.count = 1, .reusable = false}}, SHIFT(135),
  [255] = {.entry = {.count = 1, .reusable = false}}, SHIFT(137),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formula_arrow_type, 1, 0, 0),
  ...
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arrow_type, 1, 0, 0),
  [275] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arrow_type, 3, 0, 0),
  ...
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formula_arrow_type, 3, 0, 0),
  ...
  [347] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 1),
};
